...
/** @brief Event type: Frame ready event for more than one frame in a batch. Only valid for request mode.
 * Both QCARCAM_OPEN_FLAGS_MULTI_FRAME_INFO and QCARCAM_OPEN_FLAGS_REQUEST_MODE should be enabled. */
